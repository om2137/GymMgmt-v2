...
interface Props {
    ...
    changeHandler?: (e: ChangeEvent<string | HTMLInputElement | undefined>) => void;
}
export function SignInInput({ placeholder, Id, setState, error }: Props) {
    ...
    return (
        <input
            ...
            className={`text-center font-serif border-b-2 ${error ? 'border-red-500 placeholder:text-red-400' : 'border-white dark:border-cyan-950'} 
                dark:bg-white bg-cyan-950 focus:border-b-2 focus:outline-none focus:placeholder:text-white px-8 py-2`}
